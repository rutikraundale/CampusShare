...
export const updateProfile = async (req, res) => {
  try {
    ...
    if (hackathonsParticipated !== undefined)
      user.hackathonsParticipated = parseArray(hackathonsParticipated);
    if (hackathonsWon !== undefined)
      user.hackathonsWon = parseArray(hackathonsWon);
    if (codingPlatforms !== undefined)
      user.codingPlatforms = parseArray(codingPlatforms);
